```markdown
# Stock CAPM Analysis Web App README

![Web App Screenshot](CAPM.png)
...
- **Email:** kvinayakabhat@gmail.com
- **LinkedIn:** (https://www.linkedin.com/in/k-vinayaka-bhat-26517221b/)
- **GitHub:** (https://github.com/kvinayakabhat)

## Technology Used

This web app was developed using Streamlit, a powerful Python library for creating interactive and data-driven web applications.

## Acknowledgments

We extend our gratitude to the Streamlit community for providing a robust platform that enables the creation of engaging and informative web applications.
Also we would like to extend our gratitude to the Tech Classes for guiding us through out the project development.

---

Thank you for using the Stock CAPM Analysis Web App. We hope this tool proves valuable for your investment analysis and understanding of the stock market. Happy exploring!
