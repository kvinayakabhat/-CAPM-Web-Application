...
try:
    ...
    with col1:
        ...
        streamlit.dataframe(stocks_df.head(), use_container_width =True)
    with col2:
        streamlit.markdown("### DataFrame tail")
        streamlit.dataframe(stocks_df.tail(), use_container_width =True)
    ...
    with col1:
        ...
        streamlit.plotly_chart(capm_functions.interactive_plot(stocks_df))

    with col2:
        streamlit.markdown("### Price of all the stocks (After Normalization)")
        streamlit.plotly_chart(capm_functions.interactive_plot(capm_functions.normalize(stocks_df)))
    ...
    with col1:
        ...
        streamlit.dataframe(beta_df, use_container_width =True)
